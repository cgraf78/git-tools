...
complete -c git-branch-audit -l drop-merged -d "Report branches already merged into the default branch"
...
complete -c git-branch-audit -s n -l dry-run -d "Print candidate actions without changing anything"
